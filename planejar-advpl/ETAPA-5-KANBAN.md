...
- **Nada entra em DOING sem APROVADO.** Com a fila parada esperando voce, a sessao NAO pega outro card "para adiantar": ela para e diz exatamente o que esta travado e em quem.
- **Aprovacao e por card e explicita.** "pode seguir" aprova o card em discussao, nao a fila. Para liberar em lote o usuario diz quais (ou "todos os da camada N") — e voce repete a lista aprovada antes de mover.
...
Nos modos com aprovacao o card conversa: voce escreve comentarios, o usuario responde neles, e voce LE antes de agir.
...
1. Leia os comentarios do card (nos modos com aprovacao) e confirme o estado de entrada: TODO no modo livre, APROVADO nos demais
