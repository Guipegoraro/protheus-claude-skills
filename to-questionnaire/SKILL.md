...
Uso tipico no fluxo Protheus: formatar uma rodada de `perguntas-cliente.md` antes de enviar ao cliente — nesse caso escreva o documento na pasta do plano (`.claude/plans/<slug>/`) e em PT-BR, na linguagem de negocio do destinatario (regras de linguagem em `planejar-advpl/templates/decisoes-cliente.md`).
