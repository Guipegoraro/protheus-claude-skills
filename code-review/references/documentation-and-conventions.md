...
- [ ] Every Function has a `/*/{Protheus.doc}` block
...
/*/
Function CalcTotal(cCustCode, nDiscount)  // cCustCode and nDiscount undocumented
...
@table SA1, SC5
/*/
Function CalcTotal(cCustCode, nDiscount)
```
