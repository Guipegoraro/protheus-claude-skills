...
- [ ] No `TCQuery` or `TCSqlExec` calls inside loops — batch instead
- [ ] Temporary aliases (`TCQuery ... New Alias`) are closed after use
...
- [ ] `FWPreparedStatement` is used when user input is part of the query
