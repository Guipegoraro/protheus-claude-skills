...
Function getCustomer() as Logical
...
- [ ] Function name is descriptive and uses camelCase
...
- [ ] Input sanitized before use in SQL queries (`FWPreparedStatement`)
...
- [ ] SQL injection prevented (`FWPreparedStatement`)
...
- [ ] `FWPreparedStatement` used for all queries with dynamic parameters
